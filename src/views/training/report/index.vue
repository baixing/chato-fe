...
import ReportUserMsgContext from './components/ReportUserMsgContext.vue'
...
const tabComponents = {
  ...
  userMsgContext: ReportUserMsgContext
}

const onClickTab = (v) => {
  router.push({ name: RoutesMap.tranning.report, params: { type: v } })
}
</script>
